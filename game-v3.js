...
const STORY_NODES={
  intro:{step:1,kicker:'بداية الحكاية',chapter:'صباح في الغابة',text:'استيقظ ليو على لمعة صغيرة ترقص بين الأشجار. كانت فراشة مضيئة تلوّح له ثم تطير ببطء.',theme:'dawn',cue:'lion',choices:[{label:'نتبع اللمعة',hint:'لنرَ إلى أين تذهب الفراشة',next:'crossroads',icon:'✨'}]},
  ...
  river:{step:3,kicker:'صديق عند الماء',chapter:'الضفدع يعرف علامة',text:'قال الضفدع: رأيت نقاطًا لامعة تتجه نحو الزهور الكبيرة! شكره ليو وتابع الطريق.',theme:'river',friend:'frog',cue:'frog',path:'اخترت طريق النهر',choices:[{label:'نتبع آثار اللمعان',hint:'إلى حديقة الزهور',next:'flower',icon:'✨'}]},
  tree:{step:3,kicker:'صديق فوق الشجرة',chapter:'القرد يرى بعيدًا',text:'قال القرد: رأيت الفراشة تهبط قرب الزهور الكبيرة! شكره ليو وركض نحوها بهدوء.',theme:'tree',friend:'monkey',cue:'monkey',path:'اخترت طريق الشجرة',choices:[{label:'نذهب إلى الزهور',hint:'الفراشة قريبة الآن',next:'flower',icon:'🌼'}]},
  flower:{step:4,kicker:'وجدناها!',chapter:'حديقة الزهور',text:'وجد ليو الفراشة المضيئة تستريح على زهرة صفراء. كانت هادئة وتنتظر أن يحييها.',theme:'flowers',friend:'rabbit',cue:'rabbit',choices:[{label:'نقترب بهدوء',hint:'خطوات صغيرة وصوت هادئ',next:'finish',ending:'calm',icon:'🤫'},{label:'نلوّح لها',hint:'نقول مرحبًا من بعيد',next:'finish',ending:'wave',icon:'👋'}]},
...
function showScreen(name){
  ...
  const focusScreen=()=>{
    ...
    if(name==='story')selector='#storyChoices [data-autofocus]';
