...
public final class MainActivity extends Activity {
    ...
    private void createWebView() {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " BubbleSafariTV/0.8");
    ...
    private void handleBack() {
        ...
        String script = "(function(){"
                ...
                + "document.dispatchEvent(new KeyboardEvent('keydown',{key:'BrowserBack',code:'BrowserBack',keyCode:4,which:4,bubbles:true,cancelable:true}));"
                + "return id;"
                + "})()";
        ...
        webView.evaluateJavascript(script, result -> {
            if ("\"exit\"".equals(result)) {
                ...
                webView.postDelayed(webView::requestFocus, 40);
            }
        });
    }
